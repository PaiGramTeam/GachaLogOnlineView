...
class StarRailGachaLogFunctions(BaseGachaLogFunctions):
    def __init__(self):
        super().__init__()
        self.gacha_log_path = self.BASE_DATA_PATH / Game.STARRAIL.value
...
starrail_gacha_log_functions = StarRailGachaLogFunctions()

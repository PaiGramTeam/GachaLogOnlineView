...
class GenshinGachaLogFunctions(BaseGachaLogFunctions):
    def __init__(self):
        super().__init__()
        self.gacha_log_path = self.BASE_DATA_PATH / Game.GENSHIN.value
...
genshin_gacha_log_functions = GenshinGachaLogFunctions()
